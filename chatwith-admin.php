                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <aside>
                                <p class="sidebar-chat-name">Ez Kamala Akili<a href="#" data-activates="chat-messages" class="chat-message-link"><i class="material-icons">keyboard_arrow_right</i></a></p>
                                <div class="messages-container">
                                <?php 
                                        $aid = $_SESSION['aglogin'];
                                        $sql = "SELECT * from  tblchating where agid=:aid";
