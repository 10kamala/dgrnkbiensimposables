...
$username = $_SESSION['aglogin'];
$sql = "SELECT Password FROM tagent WHERE EmailId=:username and Password=:password";
...
if($query->rowCount() > 0)
{
$con = "update tagent set Password=:newpassword where EmailId=:username";
