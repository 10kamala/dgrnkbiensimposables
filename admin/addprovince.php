...
$sql = "INSERT INTO tprovince(ProvinceName,ProvinceCode,ProvinceShortName) VALUES(:provname,:provcode,:provshortname)";
    ...
    <?php include('includes/header.php');?>        
        <?php include('includes/sidebar.php');?>
                <main class="mn-inner">
                    <div class="row">
                        <div class="col s12">
                            <div class="page-title">Créer une province</div>
                        </div>
                                            ...
                                            <?php if($error){?><div class="errorWrap"><strong>erreur</strong>:<?php echo htmlentities($error); ?> </div><?php } 
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <input id="provincename" type="text"  class="validate" autocomplete="off" name="provincename"  required>
                                                            <label for="provname">Nom de la province</label>
                                                        </div>
                                                    <div class="input-field col s12">
                                                        <input id="provinceshortname" type="text"  class="validate" autocomplete="off" name="provinceshortname"  required>
                                                        <label for="provshortname">Abrévéation du nom de la province</label>
                                                    </div>
                                                    <div class="input-field col s12">
                                                        <input id="provcode" type="text" name="provcode" class="validate" autocomplete="off" required>
