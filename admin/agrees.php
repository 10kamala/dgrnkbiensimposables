...
<html lang="en">
    <head>
        <!-- Title -->
        <title>Admin | Total d'agréements</title>       
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Agreement History</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
                                        <?php 
                                            $sql = "SELECT tdetails.id as tid,tagent.FirstName,tagent.LastName,tagent.AgId,tagent.id,tdetails.AgrType,tdetails.PostingDate,tdetails.Status from tdetails join tagent on tdetails.agid=tagent.id order by tid desc";
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->AgType); ?></td>
